...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	...
	/*Enable the USB VBUS*/
	MX6_PAD_SNVS_TAMPER6__GPIO5_IO06 | MUX_PAD_CTRL(NO_PAD_CTRL),	//USB_OTG1
	MX6_PAD_SNVS_TAMPER7__GPIO5_IO07 | MUX_PAD_CTRL(NO_PAD_CTRL),	//USB_OTG2
...
static void setup_usb(void)
{
	...
	mdelay(10);
	gpio_set_value(IMX_GPIO_NR(5,6), 0);
	gpio_set_value(IMX_GPIO_NR(5,7), 0);
	mdelay(1);
}
